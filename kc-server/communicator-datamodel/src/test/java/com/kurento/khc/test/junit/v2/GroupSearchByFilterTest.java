...
public class GroupSearchByFilterTest {
	...
	@Test
	public void testGroupSearchByFilterTest() throws IOException {
		...
		for (int i = 0; i < MAX_MEMBER; i++) {
			if (i % 2 == 0)
				...
				aux = "";
			utils.createGroup(name + aux + i, acc, admin, false);
		}

		utils.login(admin);

		List<Group> searchResult = administrativeService
				.searchAccountGroupsByFilter(acc.getUUID(), PATTERN, 0, 100);
