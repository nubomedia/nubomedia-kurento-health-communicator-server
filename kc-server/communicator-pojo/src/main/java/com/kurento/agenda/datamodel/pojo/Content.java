...
public class Content extends BasePojo {
	...
	public String getUrl(String size) {
		...
		if (size != null) {
			if (size.equalsIgnoreCase("SMALL")) {
				url = getSmallThumbnailUrl();
			} else if (size.equalsIgnoreCase("MEDIUM")) {
				url = getMediumThumbnailUrl();
			} else if (size.equalsIgnoreCase("LARGE")) {
				url = getLargeThumbnailUrl();
			}
		}
		return url;
	}
	...
	public ContentReadResponse buildContentReadResponse() {
		ContentReadResponse contentResponse = new ContentReadResponse();
		contentResponse.setId(this.id);
		contentResponse.setContentSize(this.contentSize);
		contentResponse.setContentType(this.contentType);
