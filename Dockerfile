...
WORKDIR /opt
RUN wget http://apache.uvigo.es/tomcat/tomcat-7/v7.0.73/bin/apache-tomcat-7.0.73.zip > /dev/null
RUN unzip apache-tomcat-7.0.73.zip > /dev/null
WORKDIR /
...
WORKDIR /opt/apache-tomcat-7.0.73
