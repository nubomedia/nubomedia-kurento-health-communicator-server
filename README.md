...
NUBOMEDIA Kurento Health Communicator is a messaging client with multiconference capabilities. This the server side that allows mobile phones communicate each other and keep all the logic and the data to be retrieved by mobile apps.
